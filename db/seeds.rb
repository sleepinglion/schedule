...
AddressCategory.create!(id: 1, title: '청소비', enable: true)
AddressCategory.create!(id: 2, title: '계약금', enable: true)
AddressCategory.create!(id: 3, title: '추가금', enable: true)
AddressCategory.create!(id: 4, title: '환불금', enable: true)

Address.create!(id: 1, address_category_id: 1, title: '청소비', enable: true)
Address.create!(id: 2, address_category_id: 2, title: '계약금', enable: true)
Address.create!(id: 3, address_category_id: 3, title: '추가금', enable: true)
Address.create!(id: 4, address_category_id: 4, title: '환불금', enable: true)
Address.create!(id: 5, address_category_id: 1, title: '청소비', enable: true)
Address.create!(id: 6, address_category_id: 2, title: '계약금', enable: true)
Address.create!(id: 7, address_category_id: 3, title: '추가금', enable: true)
Address.create!(id: 8, address_category_id: 4, title: '환불금', enable: true)
...
User.create!(:id=>7, :name=>'최희정',:address_id=> 1)
User.create!(:id=>8, :name=>'신연우',:address_id=> 2)
User.create!(:id=>9, :name=>'(주)호성상사',:address_id=> 7)
User.create!(:id=>10, :name=>'김수자',:address_id=> 8)
